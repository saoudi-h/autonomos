...
/**
 * The Protocol kernel template — v0.3
 *
 * Design principles (v0.3):
 * - PROTOCOL.md is a compact REFERENCE, not an executable workflow.
 * - All step-by-step instructions live in the 3 workflow files.
 * - No duplication between PROTOCOL.md and workflows.
 * - Short enough that an LLM can re-scan it mid-session without cost.
 */
export const PROTOCOL_TEMPLATE = `# AUTONOMOS PROTOCOL (v${PROTOCOL_VERSION})
