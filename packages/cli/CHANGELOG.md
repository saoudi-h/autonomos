...
- [`76a986d`](https://github.com/saoudi-h/autonomos/commit/76a986d73f3ce1a31ccff612d34d88c676080996) Thanks [@saoudi-h](https://github.com/saoudi-h)! - fix(cli): declare `bin` via tsdown's `exports` config, not by disabling exports
